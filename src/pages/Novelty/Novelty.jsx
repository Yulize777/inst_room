        ...
        <section className={'favorites'}>
            <div className="container">
                <div className="category__top">
                    ...
                    <p  className="category__top__pages">{i18n.language === 'ru' ? 'Новинки'  : 'Novelties' }</p>
                </div>
                <Title title={ i18n.language === 'ru' ? 'Новинки' : 'Novelties'}/>
                <div className="favorites__cont">
                    <p>
                        {
                            `${data.filter(item => item.noveltyEn).length} ${i18n.language === 'ru' ?  'товаров' : 'product' }`
                        }
                    </p>
                ...
                <div className="favorites__block">
                    {
                        data.filter(item1 => item1.noveltyEn )
                            .map(item => (
