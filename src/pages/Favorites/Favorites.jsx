    ...
    return (
       <section className={'favorites'}>
           <div className="container">
               ...
               <Title title={ i18n.language === 'ru' ? 'Избранное' : 'Favorites'}/>
               <div className="favorites__cont">
                   <p>
                       {
                           `${data.filter(item => item.favorite).length} ${i18n.language === 'ru' ?  'товаров' : 'product' }`
                       }
                   </p>
               ...
               <div className="favorites__block">
                   {
                       data.filter(item1 => item1.favorite)
                           .map(item => (
